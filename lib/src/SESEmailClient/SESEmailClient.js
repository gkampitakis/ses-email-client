...
class SESEmailClient {
  constructor (settings = {}) {
    const { accessKeyId, secretAccessKey, region, templateLanguage, production, tmpltCacheSize, attCacheSize } = settings;
    ...
    this[transporter] = new SESTransporter(accessKeyId, secretAccessKey, region, this[prod], attCacheSize);
